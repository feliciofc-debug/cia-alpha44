...
export { resolvePesoLiqLinha, resolvePesoLiqRateio, pesoLiqReal, pesoBrutoReal, pesoBrutoPlanilhaFob, totaisPesoExibicao, AVISO_PDF_BASE_DESPACHANTE_BRUTA, type LinhaCrua, type PesoLinha, type TotaisPesoExibicao } from "./linha.js";
export {
